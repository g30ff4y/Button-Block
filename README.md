...
3. Next you will have the option to build groups (rows) of individual buttons (columns).  You can add up to six buttons per row. Use the standard Cascade Plus and Minus signs to add/delete either Groups or Buttons. Groups can be reordered with the black up and down arrows next to the add/delete options.
